    ...
    <div>
      <Grid container style={{ display: "flex" }} direction="column">
              ...
              >
                <div className={classes.paper}>
                  <MenuList id="simple-menu">
                    <MenuItem onClick={(e) => hendleRoute(e, "")}>
                      Password Validation
                    </MenuItem>
                    <MenuItem onClick={(e) => hendleRoute(e, "tags")}>
                      Tags Creator
                    </MenuItem>
                    <MenuItem onClick={(e) => hendleRoute(e, "urlValidation")}>
                      URL Validation
                    </MenuItem>
                    <MenuItem
                      onClick={(e) => hendleRoute(e, "phonevalidation")}
                    >
                      Phone Validation
                    </MenuItem>
                    <MenuItem onClick={(e) => hendleRoute(e, "ipValidation")}>
                      IP Validator
                    </MenuItem>
                    <MenuItem
                      onClick={(e) => hendleRoute(e, "SpecialCharModifier")}
                    >
                      Special char modifier
                    </MenuItem>
                    <MenuItem
                      onClick={(e) => hendleRoute(e, "emaildomainvalidation")}
                    >
                      Email domain validatin
                    </MenuItem>
                  </MenuList>
                </div>
              </Popper>
        ...
        <Switch>
          ...
          <Route
            path="/emaildomainvalidation"
            component={EmailDomainValidation}
          />
        </Switch>
      </Grid>
    </div>
